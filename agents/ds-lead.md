...
2. Localize o componente pedido em `components.json` — hoje Button, Hyperlink e Dot — e leia o contrato, as regras, os tokens e a demo que o índice declara para ele; consulte o gerador daquele componente quando precisar conferir o mapeamento de cor. Cada um tem o seu: os eixos e os números não são os mesmos entre eles, e a tabela em `agents/component-reviewer.md` diz quais são.
