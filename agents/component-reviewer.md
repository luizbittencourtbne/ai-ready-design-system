...
| | Button | Hyperlink | Dot |
| --- | --- | --- | --- |
| Para quê | ação | navegação | status |
| Elemento | `<button>` | `<a href>` | `<span>` |
| Eixo de cor | 13 temas | 9 temas | **5 tons** (`tone`, não `theme`) |
| Tamanhos | Small → XLarge | XSmall → Large | Small → Large |
| Estados | 6 | 6 | **nenhum** |
| Gerador | `scripts/build-css.mjs` | `scripts/build-hyperlink-css.mjs` | `scripts/build-dot-css.mjs` |
