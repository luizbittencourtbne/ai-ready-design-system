...
4. Compare a resposta com `review-exemplo.md`. Os números e o resultado de build daquele exemplo se referem a este pacote e podem mudar após edições futuras.
