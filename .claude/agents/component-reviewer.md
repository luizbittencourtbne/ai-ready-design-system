...
description: Revisa componentes do BambooDS sob demanda do ds-lead, com foco em contrato, tokens, HTML, estados e acessibilidade. Use em revisões de qualquer componente do índice — Button, Hyperlink ou Dot.
